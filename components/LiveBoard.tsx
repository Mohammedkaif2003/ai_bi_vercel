  ...
  return (
    <div ref={setNodeRef} style={style}>
      ...
      >
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <div className="bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20">
                  <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">{insight.filename}</span>
                </div>
                <span className="text-slate-700 text-xs">•</span>
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Statistical Insight</span>
              </div>
        ...
        <div className="flex-1 bg-black/10 p-4 min-h-[380px] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="p-8 bg-white/[0.02] border-t border-white/5 relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center gap-2 px-3 py-1 bg-indigo-500/10 border border-indigo-500/20 rounded-full">
                ...
                <span className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.2em]">AI Synthesis</span>
              </div>
            </div>
